(module
  ...
  (global $__lang_bump (export "__lang_bump") (mut i32) (i32.const 552))
(global $__rgn_tmp (mut i64) (i64.const 0))
  (global $__lang_char_table i32 (i32.const 40))
  ...
  (data (i32.const 17) "input\00")
  (data (i32.const 23) "display\00")
  (data (i32.const 31) "go\00")
