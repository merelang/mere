(module
  ...
  (data (i32.const 58) "input\00")
  (data (i32.const 64) "display\00")
  (data (i32.const 72) "go\00")
  ...
  (func $__lang_str_escape (param $s i32) (result i32)
    ...
    (global.set $__lang_bump
      (i32.add (i32.add (local.get $r) (local.get $j)) (i32.const 1)))
    (local.get $r))  (func $list_sort (param i32) (result i32)
    (local i32 i32 i32)
    i32.const 0
    local.set 2
