...
(global $__rgn_tmp (mut i64) (i64.const 0))
  ...
  (global $v (mut i64) (i64.const 0))
  (global $reg (mut i64) (i64.const 0))
  (global $stack (mut i64) (i64.const 0))
  (global $disp (mut i64) (i64.const 0))
  ...
  (func $step (param i64) (result i64)
    ...
    local.get 2
    i64.extend_i32_u)
  (func $rng_next (param i64) (result i64)
    (local i64)
    local.get 0
    i64.const 0
    call $mere_vec_get
    ...
    i64.const 255
    i64.and)
  (func $draw (param i64) (result i64)
    (local i32 i32)
    global.get $__lang_bump
    local.set 1
    local.get 1
    ...
    local.get 2
    i64.extend_i32_u)
  (func $seti (param i64) (result i64)
    (local i32 i32)
    global.get $__lang_bump
    local.set 1
    local.get 1
    ...
    local.get 2
    i64.extend_i32_u)
  (func $geti (param i64) (result i64)
    local.get 0
    i64.const 1
    call $mere_vec_get)
  (func $blit_bytes (param i64) (result i64)
    (local i32 i32)
    global.get $__lang_bump
    local.set 1
    local.get 1
  ...
  (func $new_vec (param i64) (result i64)
    ...
    local.get 2
    i64.extend_i32_u)
  (func $mask12 (param i64) (result i64)
    local.get 0
    i64.const 4095
    i64.and)
  ...
  (func $list_fold (param i64) (result i64)
    ...
    local.get 2
    i64.extend_i32_u)
  (func $__lifted_go_7 (param i64) (param i64) (param i64) (param i64) (result i64)
    local.get 3
    local.get 0
    i64.ge_s
    i64.extend_i32_u
  ...
  (func $__lifted_go_6 (param i64) (param i64) (param i64) (param i64) (param i64) (result i64)
    local.get 4
    local.get 0
    i64.ge_s
    i64.extend_i32_u
  ...
  (func $__lifted_col_5 (param i64) (param i64) (param i64) (param i64) (param i64) (param i64) (param i64) (result i64)
  ...
  (func $__lifted_row_4 (param i64) (param i64) (param i64) (param i64) (param i64) (param i64) (param i64) (param i64) (result i64)
    (local i64)
    local.get 7
    local.get 0
    i64.ge_s
  ...
  (func $__lifted_cl_3 (param i64) (param i64) (result i64)
    local.get 1
    i64.const 2048
    i64.ge_s
    i64.extend_i32_u
  ...
  (func $__lifted_skip_2 (param i64) (param i64) (result i64)
    local.get 0
    i64.const 0
    local.get 0
    i64.const 0
  ...
  (func $__lifted_run_0 (param i64) (param i64) (param i64) (param i64) (param i64) (param i64) (param i64) (param i64) (result i64)
  ...
  (func $step_closure (param i64) (param i64) (result i64)
    local.get 1
    call $step)
  (func $rng_next_closure (param i64) (param i64) (result i64)
    local.get 1
    call $rng_next)
  (func $draw_closure (param i64) (param i64) (result i64)
    local.get 1
    call $draw)
  (func $seti_closure (param i64) (param i64) (result i64)
    local.get 1
    call $seti)
  (func $geti_closure (param i64) (param i64) (result i64)
    local.get 1
    call $geti)
  (func $blit_bytes_closure (param i64) (param i64) (result i64)
    local.get 1
    call $blit_bytes)
  (func $new_vec_closure (param i64) (param i64) (result i64)
    local.get 1
    call $new_vec)
  (func $mask12_closure (param i64) (param i64) (result i64)
    local.get 1
    call $mask12)
