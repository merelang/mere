...
(global $__rgn_tmp (mut i64) (i64.const 0))
  ...
  (func $__lang_str_count (param $s8 i64) (param $n8 i64) (result i64)
    ...
    (block $end
      (loop $lp
        ...
        (br $lp)))
    (i64.extend_i32_s (local.get $acc)))
  (func $greet (param i64) (result i64)
    i64.const 16
    local.get 0
  ...
  (func $list_fold (param i64) (result i64)
    ...
    local.get 2
    i64.extend_i32_u)
  (func $greet_closure (param i64) (param i64) (result i64)
    local.get 1
    call $greet)
