...
(global $__rgn_tmp (mut i64) (i64.const 0))
  ...
  (data (i32.const 16) "fizzbuzz\00")
  (data (i32.const 25) "fizz\00")
  (data (i32.const 30) "buzz\00")
  (data (i32.const 35) "\00")
  (data (i32.const 36) "()\00")
  (data (i32.const 39) "\00")
  (data (i32.const 40) "\00")
  (data (i32.const 41) " \00")
  (data (i32.const 43) " \00")
  ...
  (func $__lang_str_count (param $s8 i64) (param $n8 i64) (result i64)
    ...
    (block $end
      (loop $lp
        ...
        (br $lp)))
    (i64.extend_i32_s (local.get $acc)))
  (func $walk (param i64) (result i64)
    (local i64 i32 i32 i64 i32 i64 i32 i64 i32 i32 i32 i32)
    local.get 0
    local.set 1
    local.get 1
    i32.wrap_i64
  ...
  (func $fizzbuzz_at (param i64) (result i64)
    local.get 0
    i64.const 15
    i64.rem_s
    i64.const 0
  ...
  (func $list_fold (param i64) (result i64)
    ...
    local.get 2
    i64.extend_i32_u)
  (func $walk_closure (param i64) (param i64) (result i64)
    local.get 1
    call $walk)
  (func $fizzbuzz_at_closure (param i64) (param i64) (result i64)
    local.get 1
    call $fizzbuzz_at)
