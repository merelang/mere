(module
  ...
  (table 23 funcref)
  (elem (i32.const 0) $fizzbuzz_closure $list_sort_closure $list_sort_by_closure $list_sort_insert_closure $list_min_closure $list_max_closure $list_product_closure $list_sum_closure $range_closure $list_fold_closure $anon_0_fn $anon_1_fn $anon_2_fn $anon_3_fn $anon_4_fn $anon_5_fn $anon_6_fn $anon_7_fn $anon_8_fn $anon_9_fn $anon_10_fn $anon_11_fn $anon_12_fn)
  (global $__lang_bump (mut i32) (i32.const 589))
  (global $__lang_char_table i32 (i32.const 77))
  ...
  (data (i32.const 58) "FizzBuzz\00")
  (data (i32.const 67) "Fizz\00")
  (data (i32.const 72) "Buzz\00")
  ...
  (func $__lang_str_escape (param $s i32) (result i32)
    ...
    (global.set $__lang_bump
      (i32.add (i32.add (local.get $r) (local.get $j)) (i32.const 1)))
    (local.get $r))  (func $fizzbuzz (param i32) (result i32)
    (local i32 i32)
  ...
  (func $list_fold (param i32) (result i32)
    ...
    i32.store offset=4
    local.get 2)
  (func $fizzbuzz_closure (param i32) (param i32) (result i32)
    local.get 1
    call $fizzbuzz)
