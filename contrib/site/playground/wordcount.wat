(module
  ...
  (global $__lang_bump (export "__lang_bump") (mut i32) (i32.const 677))
(global $__rgn_tmp (mut i64) (i64.const 0))
  (global $__lang_char_table i32 (i32.const 165))
  ...
  (data (i32.const 44) "\00")
  (data (i32.const 45) "i\00")
  (data (i32.const 47) "i\00")
  (data (i32.const 49) "\0a\00")
  (data (i32.const 51) "n\00")
  (data (i32.const 53) "n\00")
  (data (i32.const 55) "i\00")
  (data (i32.const 57) "i\00")
  (data (i32.const 59) "i\00")
  (data (i32.const 61) " \00")
  (data (i32.const 63) "\09\00")
  (data (i32.const 65) "\0a\00")
  (data (i32.const 67) "\0d\00")
  (data (i32.const 69) "in_word\00")
  (data (i32.const 77) "in_word\00")
  (data (i32.const 85) "count\00")
  (data (i32.const 91) "count\00")
  (data (i32.const 97) "in_word\00")
  (data (i32.const 105) "i\00")
  (data (i32.const 107) "input\00")
  (data (i32.const 113) "count-btn\00")
  (data (i32.const 123) "out-chars\00")
  (data (i32.const 133) "out-words\00")
  (data (i32.const 143) "out-lines\00")
  (data (i32.const 153) "0\00")
  (data (i32.const 155) "0\00")
  (data (i32.const 157) "0\00")
  (data (i32.const 159) "\00")
  (data (i32.const 160) "\00")
  (data (i32.const 161) " \00")
  (data (i32.const 163) " \00")
      ...
      (loop $lp
        ...
        (if (local.get $match)
          ...
          (else
            (local.set $i (i32.add (local.get $i) (i32.const 1)))))
        (br $lp)))
    (i64.extend_i32_s (local.get $acc)))  (func $mere_map_key_eq_str (param $a i64) (param $b i64) (result i64)
  ...
  (func $mere_map_str_delete (param $m8 i64) (param $k i64) (result i64)
    ...
    (block $notf (loop $probe
      ...
      (local.set $s (i32.and (i32.add (local.get $s) (i32.const 1)) (local.get $icm1)))
      (br $probe)))
    (i64.const 0))  (func $count_words (param i64) (result i64)
    (local i64 i64)
    local.get 0
    call $__lang_strlen
    local.set 1
  ...
  (func $count_lines (param i64) (result i64)
    (local i64 i64)
    local.get 0
    call $__lang_strlen
    local.set 1
  ...
  (func $list_fold (param i64) (result i64)
    ...
    local.get 2
    i64.extend_i32_u)
  (func $__lifted___while___cx_0_1 (param i64) (param i64) (param i64) (param i64) (result i64)
    (local i64)
    local.get 0
    i64.const 45
    call $mere_map_str_get
  ...
  (func $__lifted___while___cx_1_0 (param i64) (param i64) (param i64) (param i64) (result i64)
    (local i64 i64 i64)
    local.get 0
    i64.const 57
    call $mere_map_str_get
  ...
  (func $count_words_closure (param i64) (param i64) (result i64)
    local.get 1
    call $count_words)
  (func $count_lines_closure (param i64) (param i64) (result i64)
    local.get 1
    call $count_lines)
