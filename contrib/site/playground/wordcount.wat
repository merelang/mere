(module
  ...
  (data (i32.const 16) "i\00")
  (data (i32.const 18) "count\00")
  (data (i32.const 24) "in_word\00")
  (data (i32.const 32) "count\00")
  (data (i32.const 38) "i\00")
  (data (i32.const 40) "n\00")
  (data (i32.const 42) "n\00")
  (data (i32.const 44) "list_min: empty list\00")
  (data (i32.const 65) "list_max: empty list\00")
  (data (i32.const 86) "i\00")
  (data (i32.const 88) "i\00")
  (data (i32.const 90) "\0a\00")
  (data (i32.const 92) "n\00")
  (data (i32.const 94) "n\00")
  (data (i32.const 96) "i\00")
  (data (i32.const 98) "i\00")
  (data (i32.const 100) "i\00")
  (data (i32.const 102) " \00")
  (data (i32.const 104) "\09\00")
  (data (i32.const 106) "\0a\00")
  (data (i32.const 108) "\0d\00")
  (data (i32.const 110) "in_word\00")
  (data (i32.const 118) "in_word\00")
  (data (i32.const 126) "count\00")
  (data (i32.const 132) "count\00")
  (data (i32.const 138) "in_word\00")
  (data (i32.const 146) "i\00")
  (data (i32.const 148) "input\00")
  (data (i32.const 154) "count-btn\00")
  (data (i32.const 164) "out-chars\00")
  (data (i32.const 174) "out-words\00")
  (data (i32.const 184) "out-lines\00")
  (data (i32.const 194) "0\00")
  (data (i32.const 196) "0\00")
  (data (i32.const 198) "0\00")
  ...
  (func $__lang_str_escape (param $s i32) (result i32)
    ...
    (global.set $__lang_bump
      (i32.add (i32.add (local.get $r) (local.get $j)) (i32.const 1)))
    (local.get $r))  (func $mere_map_key_eq_str (param $a i32) (param $b i32) (result i32)
  ...
  (func $mere_map_str_delete (param $m i32) (param $k i32) (result i32)
    ...
    (block $find_done
      (loop $find_lp
        ...
        (local.set $i (i32.add (local.get $i) (i32.const 1)))
        (br $find_lp)))
    (i32.const 0))  (func $count_words (param i32) (result i32)
    (local i32 i32)
    local.get 0
    call $__lang_strlen
    local.set 1
    ...
    local.get 0
    i32.const 0
    call $__lifted___while___cx_1_0
    drop
    local.get 2
    i32.const 32
    call $mere_map_str_get)
  (func $count_lines (param i32) (result i32)
    (local i32 i32)
    local.get 0
    call $__lang_strlen
    local.set 1
    ...
    local.get 0
    i32.const 0
    call $__lifted___while___cx_0_1
    drop
    local.get 2
    i32.const 42
    call $mere_map_str_get
  ...
  (func $list_fold (param i32) (result i32)
    ...
    i32.store offset=4
    local.get 2)
  (func $__lifted___while___cx_0_1 (param i32) (param i32) (param i32) (param i32) (result i32)
    (local i32)
    local.get 0
    i32.const 86
    call $mere_map_str_get
    ...
    local.get 2
    i32.const 0
    return_call $__lifted___while___cx_0_1
    else
    i32.const 0
    end)
  (func $__lifted___while___cx_1_0 (param i32) (param i32) (param i32) (param i32) (result i32)
    (local i32 i32 i32)
    local.get 0
    i32.const 98
    call $mere_map_str_get
    ...
    local.get 2
    i32.const 0
    return_call $__lifted___while___cx_1_0
    else
    i32.const 0
    end)
  (func $count_words_closure (param i32) (param i32) (result i32)
    local.get 1
    call $count_words)
  (func $count_lines_closure (param i32) (param i32) (result i32)
    local.get 1
    call $count_lines)
