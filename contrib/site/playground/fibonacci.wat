...
(global $__rgn_tmp (mut i64) (i64.const 0))
  ...
  (data (i32.const 17) "\00")
  (data (i32.const 18) "\00")
  (data (i32.const 19) " \00")
  ...
  (func $list_fold (param i64) (result i64)
    ...
    local.get 2
    i64.extend_i32_u)
  (func $fib_closure (param i64) (param i64) (result i64)
    local.get 1
    call $fib)
