(module
  ...
  (global $__lang_bump (mut i32) (i32.const 583))
  (global $__lang_char_table i32 (i32.const 71))
  ...
  (data (i32.const 58) "count\00")
  (data (i32.const 64) "tick\00")
  (data (i32.const 69) "0\00")
  ...
  (func $mere_vec_concat (param $a i32) (param $b i32) (result i32)
    ...
    (block $end_b
      (loop $lp_b
        ...
        (local.set $i (i32.add (local.get $i) (i32.const 1)))
        (br $lp_b)))
    (local.get $new))  (func $list_sort (param i32) (result i32)
    (local i32 i32 i32)
    i32.const 0
    local.set 2
