...
(global $__rgn_tmp (mut i64) (i64.const 0))
  ...
  (data (i32.const 636) "\00")
  (data (i32.const 637) "\00")
  (data (i32.const 638) "\00")
  (data (i32.const 639) " \00")
  (data (i32.const 641) " \00")
  (data (i32.const 643) "\22\00")
  (data (i32.const 645) "\22:\22\00")
  (data (i32.const 649) "\00")
  (data (i32.const 650) "\22\00")
  (data (i32.const 652) "\00")
  (data (i32.const 653) "\5c\00")
  (data (i32.const 655) "\5c\5c\00")
  (data (i32.const 658) "\22\00")
  (data (i32.const 660) "\5c\22\00")
  (data (i32.const 663) "\0a\00")
  (data (i32.const 665) "\5cn\00")
  (data (i32.const 668) "\0d\00")
  (data (i32.const 670) "\5cr\00")
  (data (i32.const 673) "\09\00")
  (data (i32.const 675) "\5ct\00")
  (data (i32.const 678) "{\22status\22:201,\00")
  (data (i32.const 693) "\22headers\22:{\22content-type\22:\22application/json\22},\00")
  (data (i32.const 740) "\22body\22:\22\00")
  (data (i32.const 749) "{\22id\22:\22\00")
  (data (i32.const 757) "\22,\22url\22:\22/s/\00")
  (data (i32.const 770) "\22}\00")
  (data (i32.const 773) "\22,\00")
  (data (i32.const 776) "\22kv_put\22:{\22key\22:\22\00")
  (data (i32.const 794) "\22,\22value\22:\22\00")
  (data (i32.const 806) "\22}}\00")
  ...
  (func $handler (param i64) (result i64)
  ...
  (func $resp_bad_request (param i64) (result i64)
    i64.const 96
    i64.const 111
    call $__lang_str_concat
    i64.const 152
  ...
  (func $resp_not_found (param i64) (result i64)
    ...
    i64.const 229
    call $__lang_str_concat)
  (func $resp_snippet_found (param i64) (result i64)
    i64.const 232
    i64.const 247
    call $__lang_str_concat
    i64.const 303
    ...
    i64.const 312
    call $__lang_str_concat)
  (func $resp_share_created (param i64) (result i64)
    (local i32 i32)
  ...
  (func $handler_closure (param i64) (param i64) (result i64)
    local.get 1
    call $handler)
  (func $resp_bad_request_closure (param i64) (param i64) (result i64)
    local.get 1
    call $resp_bad_request)
  (func $resp_not_found_closure (param i64) (param i64) (result i64)
    local.get 1
    call $resp_not_found)
  (func $resp_snippet_found_closure (param i64) (param i64) (result i64)
    local.get 1
    call $resp_snippet_found)
  (func $resp_share_created_closure (param i64) (param i64) (result i64)
    local.get 1
    call $resp_share_created)
